# ROSpider Documentation

This repository contains the ROSpider VitePress documentation site. The
...
The staged production files are generated in `projects/ROSpider/en/latest/`.
...
```text
https://GITHUB-USERNAME.github.io/ROSpider-vite/projects/ROSpider/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/ROSpider/en/latest/
```
